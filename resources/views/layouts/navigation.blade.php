            ...
            <div class="flex justify-between h-16">
                <div class="flex">
                    ...
                    <div class="flex items-center">
                        <Link href="/dashboard">
                        <h8 class="ml-[-8rem]" style="font-family: Impact;font-size: 20px"><span style="color: #1fc564">EMS DASHBOARD</span> </h8>
                            </Link>
                    </div>
                ...
                <div class="hidden sm:flex sm:items-center sm:ml-6">
                    <x-dropdown placement="bottom-end">
                        <x-slot name="trigger">
                            <button class="flex items-center text-sm font-medium text-gray-200 hover:text-lime-700 focus:outline-none transition duration-150 ease-in-out">
